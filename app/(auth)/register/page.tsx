...
import { registerUser } from "@/actions/auth"; // Adjust import path as needed
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d0a1a] flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden flex-col items-center justify-center px-16 fixed h-screen top-0 left-0">
      ...
      {/* ── Right panel: form ── */}
      <div className="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 relative lg:ml-auto">
        ...
        <div className="relative z-10 w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <h2
              ...
              style={{ fontFamily: "'Cormorant Garamond', serif" }}
            >
              Create your <span className="text-purple-300">account</span>
            </h2>
          </div>
          ...
          {/* ── UNIFIED FORM ── */}
          <form action={clientSubmit} className="space-y-5">
            {/* Hidden role input for FormData */}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-purple-800/30 rounded-xl px-4 py-3.5 text-white placeholder-white/20 text-sm focus:outline-none focus:border-purple-500/60 focus:bg-white/[0.05] hover:border-purple-700/40 transition-all duration-300"
                />
              </div>
              ...
              <div>
                <label className="block text-[11px] tracking-[0.2em] uppercase text-purple-300/50 mb-2">
                  Phone <span className="text-purple-500/30 normal-case tracking-normal">(optional)</span>
                </label>
                <input
                  type="tel"
                  name="phone"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-white/[0.03] border border-purple-800/30 rounded-xl px-4 py-3.5 pr-12 text-white placeholder-white/20 text-sm focus:outline-none focus:border-purple-500/60 focus:bg-white/[0.05] hover:border-purple-700/40 transition-all duration-300"
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full bg-white/[0.03] border rounded-xl px-4 py-3.5 pr-12 text-white placeholder-white/20 text-sm focus:outline-none focus:bg-white/[0.05] hover:border-purple-700/40 transition-all duration-300
            ...
            {/* Terms */}
            <p className="text-purple-400/30 text-xs text-center leading-relaxed py-2">
              By creating an account you agree to our{" "}
              <Link href="/terms" className="text-purple-400/50 hover:text-purple-300/70 underline underline-offset-2">Terms</Link>{" "}
              &{" "}
              <Link href="/privacy" className="text-purple-400/50 hover:text-purple-300/70 underline underline-offset-2">Privacy Policy</Link>
            </p>
            ...
            <div className="pt-2">
              <button
                type="submit"
                disabled={isLoading}
                className="relative w-full py-4 rounded-xl font-light text-sm tracking-[0.15em] uppercase bg-gradient-to-r from-purple-700 to-purple-600 text-white/90 overflow-hidden hover:from-purple-600 hover:to-purple-500 disabled:opacity-60 disabled:cursor-not-allowed transition-all duration-300 group"
              >
